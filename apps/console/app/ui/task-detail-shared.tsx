...
import { Activity, FileText, ScrollText, Terminal } from "lucide-react";
import type { Tone } from "./shared";

export type DetailTabKey = "overview" | "timeline" | "execution" | "logs";
...
export const EVENT_META: Record<string, EventMeta> = {
  ...
  auto_merge_skipped: { label: "PR 不可合并·跳过自动合并", tone: "waiting" },
